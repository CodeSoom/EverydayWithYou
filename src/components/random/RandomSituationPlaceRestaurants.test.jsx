...
import RandomSituationPlaceRestaurants from './RandomSituationPlaceRestaurants';

jest.mock('react-redux');

describe('RandomSituationPlaceRestaurants', () => {
  const mock = jest.fn();
  ...
  const renderRandomSituationPlaceRestaurants = () => render((
    <MemoryRouter>
